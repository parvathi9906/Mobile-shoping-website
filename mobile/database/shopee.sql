...
INSERT INTO `transaction` (`fullname`, `email`, `addr`, `city`, `state`, `zip`,`cardname`,`cardno`,`expmon`,`expyear`,`cvv`) VALUES
('sa,j,cns','kmendki98@gmail.com','sacu', 'ckaskjc','ckaskjc','577527','gdygedjeygeg','1111-2222-3333-4444','dd/mm/yyyy','yyyy','453');
