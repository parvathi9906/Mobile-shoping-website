...
<section id="blogs">
    <div class="container py-4">
        <h4 class="font-rubic font-size-20">Latest Blogs</h4>
        <hr>
        ...
        <div class="owl-carousel owl-theme">
            <div class="item">
                <div class="card border-0 font-rale mr-5" style="width:18rem;">
                    ...
                    <p class="card-text font-size-14 text-black-50 py-1">Lorem ipsum dolor sit amet consectetur adipisicing elit. In, quo! Sed dignissimos nostrum dicta dolorem eum expedita sit atque magnam!</p>
